...
MIDDLEWARE = [
    'scap.middleware.admin_banner.AdminBannerMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'scap.context_processors.approver_group',
                'scap.context_processors.user_groups',
            ],
        },
    },
]
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, "scap", "static"),
)
