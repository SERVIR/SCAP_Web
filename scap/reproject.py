...
def write_gtiff(source):
    ...
    """
    match = r"/home/alex/shared/SCAP/agb/Resampled_1ha/global_agb_2000_liu_.tif"
    dtype = gdal.GDT_UInt16
    nbands = 1
    nodata = -9999
    ...
    for dir in subdirs:
        if dir != 'cci':
            ...
            for file in files:
                ...
                source = write_gtiff(source)
        print("Done with {}".format(dir))
        print()

reproject_from_root('/home/alex/shared/SCAP/fcc_working/fcc/')
